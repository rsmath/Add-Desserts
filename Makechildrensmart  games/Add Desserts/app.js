...
const closurepage = document.getElementById("closurepage");
...
// dessert pictures, defined in beginGame(), used to store the images
// ==================================================================
let firstPics; 
let secondPics;
// ==================================================================
...
function beginGame() {
    // checking if rounds have ended, so to end the game
    if (round == 4) {
        closurepage.style.visibility = "visible";
...
function clicked(num) {
    ...
    if (numClicked <= 2) {
        if (choicePicked == correct) {
            numClicked = 0; // resetting number of wrong tries
            ...
            setTimeout(beginGame, goodjob.duration);
